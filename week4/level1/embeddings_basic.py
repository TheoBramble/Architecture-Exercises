...
sentences = [
    "Humans evolve over millions of years.",
    "Dogs eat alot of food everyday to survive.",
    "My dad has to eat fourteen packets of crips to live.",
    "The moniter allows the user to visually understand the computer.",
    "Race cars have to be lighter or more powerful to be faster.",
    "Only david can run two marathons back to back to save the world.",
    "Dogs fly because of the lift generated by their packets of crisps.",
